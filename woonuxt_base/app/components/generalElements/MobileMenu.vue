...
const links = [
  ...
  { text: "Rólunk", to: "/", prefetch: false },
  { text: "Galéria", to: "/", prefetch: false },
...
<template>
  <div
    class="bg-white flex flex-col max-w-lg shadow-lg top-0 bottom-0 left-0 w-11/12 z-50 fixed overflow-x-hidden p-20 mobil-menu">
